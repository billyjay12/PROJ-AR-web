...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="<%=ResolveUrl("~/") %>Scripts/ChangesForApproval.js" type="text/javascript"></script> 

    <style type="text/css">
        #tbl_listofsochanges { color:Black; font-size:11px }
        #tbl_listofsochanges th { background:#ebf5fc; padding:3px; }
        #tbl_listofsochanges td { padding: 3px 5px 3px 5px; }
        #tbl_listofsochanges td a { color:#da4707; font-weight:bold; text-decoration:none; }
    ...
    <div class="page_header_y">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="3">
                    Show
                    <select id="SelectOptionEntries" onchange="ShowEntries()">
    ...
    <div class="simple_box" style="padding:0;">
		<table id="tbl_listofsochanges" width="100%" cellpadding="2" cellspacing="0" border="0" style="color:#000000;">
            <tr align="left">
