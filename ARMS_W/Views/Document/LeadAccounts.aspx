...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% 
        ...
        if (Request.QueryString["name"] != "" && Request.QueryString["name"] != null)
        {
            ...
            ActMsg.Add("Searched " + name + " keyword on Name on the List of Lead Customers");
        }
        ...
        if (Request.QueryString["encodedby"] != "" && Request.QueryString["encodedby"] != null)
        {
            ...
            ActMsg.Add("Searched " + encodedby + " keyword on Encoded by on the List of Lead Customers");
        }
    ...
    <script src="<%=ResolveUrl("~/") %>Scripts/LeadAccounts.js" type="text/javascript"></script>
        ...
        <div class="simple_box" style="padding:0;">
		    <table id="tbl_lst_accounts" width="100%" cellpadding="2" cellspacing="0" border="0" >
                <tr>
				    ...
				    <th align="left">Proposed Lead Code</th>
                    <th align="left">SAP Lead Code</th>
                ...
                <% 
                    ...
                    mtable = SqlDbHelper.getDataDT(SqlQueryHelper.LifOfLeadAccounts(name, datecreated, encodedby, status));
                    ...
                    foreach (DataRow itm in mtable.Rows) 
                    {
                        ...
                        if (Ousr.HasPosAndRegionsOf(RegionUsers, itm["region"].ToString()))
                        {
                            // REGION
                            CanViewCurrentDoc = true;
                        }
                        else if (Ousr.HasPosAndAreasOf(AreaUsers, itm["area"].ToString()))
                        {
                            // AREA
                            CanViewCurrentDoc = true;
                        }
                        else if (
                            Ousr.HasPosAndChannelsOf(ChannelUsers, itm["channel"].ToString()) ||
                            Ousr.HasPosAndChannelGroupOf(new string[] { "chm" }, itm["ProposedChannel"].ToString())
                            )
                        {
                            // CHANNEL
                            CanViewCurrentDoc = true;
                        ...
                        else if (Ousr.HasAccountsOf("SO", itm["acctcode"].ToString()))
                        {
                            // SO
                            CanViewCurrentDoc = true;
                        }
                        ...
                        if (CanViewCurrentDoc == true)
                        {
                            ...
                            LDocs.DocList.Add(
                                    new string[] { 
                                        ...
                                        itm["name"].ToString(), 
                                        itm["proposedleadcode"].ToString(), 
                                        itm["sapleadcode"].ToString().Trim(),
                    ...
                    other_options = ResolveUrl("~/") + "Document/LeadAccounts";
