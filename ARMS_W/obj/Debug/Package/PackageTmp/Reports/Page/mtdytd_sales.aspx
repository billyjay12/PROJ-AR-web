<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mtdytd_sales.aspx.cs" Inherits="ARMS_W.Reports.Page.mtdytd_sales" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Reports\RDLC\mtdytd_sales.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="SqlDataSource1" Name="rpt_mtdytd_sales" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <br />
