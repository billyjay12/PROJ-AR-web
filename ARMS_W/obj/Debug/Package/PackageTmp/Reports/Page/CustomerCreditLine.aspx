<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerCreditLine.aspx.cs" Inherits="ARMS_W.Reports.Page.CustomerCreditLine" %>
...
<body>
   ...
   <div style="height:640px; width:800px; margin-right: 7px;">
        ...
        <asp:DropDownList ID="dropdwnRegion" runat="server" style="margin-top: 0px">
        </asp:DropDownList>
        <asp:Label ID="Label2" runat="server" Text="Channel"></asp:Label>
       <asp:DropDownList ID="dropdwnChannel" runat="server">
        </asp:DropDownList>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <ServerReport ReportPath="/arms reports/Customer_Credit_Line_Data" 
