<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="monthlyinventorycount.aspx.cs" Inherits="ARMS_W.Reports.Page.monthlyinventorycount" %>
...
<body>
    ...
    <div>
            ...
            &nbsp;
            <asp:DropDownList ID="month" runat="server" onselectedindexchanged="month_SelectedIndexChanged" AutoPostBack="true">
            </asp:DropDownList>
    ...
    <div>
       <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="550px" ShowBackButton="false" ShowCredentialPrompts="False" 
            ...
            <LocalReport ReportPath="Reports\RDLC\monthlyinventorycount.rdlc">
            </LocalReport>
    </rsweb:ReportViewer>
        <br />
    </div>
