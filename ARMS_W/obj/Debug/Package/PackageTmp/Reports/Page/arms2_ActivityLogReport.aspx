<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="arms2_ActivityLogReport.aspx.cs" Inherits="ARMS_W.Reports.Page.arms2_ActivityLogReport" %>
...
<body>
    ...
    <asp:CalendarExtender
        ...
        <br />
        <br />
        Name: <asp:DropDownList ID="cmb_empname" runat="server" 
            onselectedindexchanged="cmb_empname_SelectedIndexChanged"></asp:DropDownList> &nbsp;
...
&nbsp;<rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            Height="686px">
            <ServerReport ReportPath="/arms reports/activitylogreport" 
