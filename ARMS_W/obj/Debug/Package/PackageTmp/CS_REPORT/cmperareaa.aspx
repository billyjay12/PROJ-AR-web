<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cmperareaa.aspx.cs" Inherits="ARMS_W.CS_REPORT.cmperareaa" %>
    ...
    <div class="simple_box">
       <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" 
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="~\CS_REPORT\rpt\cmparea.rpt">
            </Report>
