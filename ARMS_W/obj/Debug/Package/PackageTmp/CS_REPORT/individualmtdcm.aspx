<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="individualmtdcm.aspx.cs" Inherits="ARMS_W.CS_REPORT.individualmtdcm" %>
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td align="left" valign="middle">
                    <b>INDIVIDUAL CREDIT MEMO - LEDGER TYPE (MTD)</b>
                </td>
   ...
   <div class="page_header_y">
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Text="Select Customer: "></asp:Label>
         <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="acctname" 
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="~\CS_REPORT\rpt\individual-mtd-cm-report.rpt">
            </Report>
