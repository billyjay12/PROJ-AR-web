<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WeatherWoodPriceList.aspx.cs" Inherits="ARMS_W.CS_REPORT.WeatherWoodPriceList" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <div class="simple_box">
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="~\CS_REPORT\rpt\WeatherWoodPricelist.rpt">
            </Report>
