<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="discIndividualActBrand.aspx.cs" Inherits="ARMS_W.CS_REPORT.discIndividualActBrand" %>
    ...
    <div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="left" valign="middle">
                            <b>INDIVIDUAL DISCOUNT PER BRAND</b>
                        </td>
      ...
      <asp:Label ID="Label1" runat="server" Text="Select Customer:"></asp:Label>
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <report filename="~\CS_REPORT\rpt\Disc-IndividualAccount-ByBrand.rpt">
            </report>
