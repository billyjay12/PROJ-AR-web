<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PCWPriceListCabDraw.aspx.cs" Inherits="ARMS_W.CS_REPORT.PCWPriceListCabDraw" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <div style="padding:5px 8px 5px 8px; background:#2982b6; color:White;">
        <b>PCW (CABINETS AND DRAWERS) PRICELIST</b>
    </div>
    ...
    <div class="simple_box">
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="~\CS_REPORT\rpt\PCWPricelistCabDraw.rpt">
            </Report>
