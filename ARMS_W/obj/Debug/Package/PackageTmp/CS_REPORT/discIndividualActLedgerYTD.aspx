<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="discIndividualActLedgerYTD.aspx.cs" Inherits="ARMS_W.CS_REPORT.discIndividualActLedgerYTD" %>
...
<body>
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td align="left" valign="middle">
                    <b>INDIVIDUAL DISCOUNT - LEDGER TYPE (YTD)</b>
                </td>
   ...
   <div class="page_header_y">
      ...
      <asp:Label ID="Label1" runat="server" Text="Select Customer:"></asp:Label>
        ...
        <asp:Button ID="btnOk" runat="server" Text="OK" Width="91px" 
    ...
    <div class="simple_box">
        <cr:crystalreportviewer ID="CrystalReportViewer1" runat="server" 
            ...
            Height="50px" ToolbarImagesFolderUrl="" ToolPanelWidth="200px" 
            Width="350px" />
        <cr:crystalreportsource ID="CrystalReportSource1" runat="server">
            <report filename="~\CS_REPORT\rpt\Disc-RunningYTD-IndividualAccount.rpt">
            </report>
