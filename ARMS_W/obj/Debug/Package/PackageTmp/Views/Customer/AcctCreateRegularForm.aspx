...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<script src="<%=ResolveUrl("~/") %>Scripts/add_cust_reg.js" type="text/javascript"></script>
...
//            $("#txt_credit_terms_eco_plywood").addClass("required_fields");
    ...
    <div class="page_header">
        <table border="0" cellpadding="0" cellspacing="0" >
            <tr>
                <td align="left">
                    <b>Customer Creation Approval</b>
                </td>
                <td align="right">
		...
		<table width="100%" cellpadding="1" cellspacing="0" border="0">
			...
			<tr>
				...
				<td align="left" colspan="4">
					<label><input type="radio" id="acc_type_direct" name="option1" value="Direct" checked="checked" onclick="javascript:RequiredFields('Direct');" />Direct</label>
					&nbsp;&nbsp;
					<label><input type="radio" id="acc_type_indirect" name="option1" value="Indirect" onclick="javascript:RequiredFields('Indirect');"/>Indirect</label>
				</td>
			</tr>
			<tr>
				<td>Key Account</td>
			...
			<tr>
				...
				<td colspan="4">
					<input type="text" id="txt_delivery_add" style="width:99%;" maxlength="100" />
				</td>
			</tr>
			<tr>
				<td colspan="5" >
					...
					<div class="margin_box" style="background-color:#ededed;">
						...
						<div class="simple_box" style="font-weight:bold; font-size:11px; background-color:#fff9df; color:#000000; border:1px solid #ffe787;">
								...
								<i> 
									...
									Clicking other business type will erase the info/data under 
									business type.
								</i>
						</div>
			...
			<tr>
				<td colspan="5" style="padding:5px;">
					<div class="blinker">
                        ...
                        <div ><i style="color:Red; font-size: 10">To fast track your account approval 
                            process, please provide complete bank information.</i> </div>
					</div>
				</td>
			</tr>
		</table>
