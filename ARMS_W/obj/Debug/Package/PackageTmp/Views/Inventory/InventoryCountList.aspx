...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="<%=ResolveUrl("~/") %>Scripts/inventoryCountList.js" type="text/javascript"></script>
    ...
    <script src="<%=ResolveUrl("~/") %>Scripts/jquery.blockUI.js" type="text/javascript"></script>
     ...
     <%--<link rel="stylesheet" href="<%=ResolveUrl("~/") %>Content/jquery.dataTables.css"  type="text/css">--%>
