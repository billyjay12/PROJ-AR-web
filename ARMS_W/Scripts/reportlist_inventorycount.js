...
function ShowReportViewer(rpt_name) {
    ...
    switch (rpt_name) {
        case "monthlyinventorycount":
            params["page"] = "monthlyinventorycount";
            break;
        case "quarterlyinventorycount":
            params["page"] = "quarterlyinventorycount";
            break;
        case "annualinventorycount":
            params["page"] = "annualinventorycount";
            break;
        case "inventorycountreport":
            params["page"] = "inventorycountreport";
            break;
        default:
    }
