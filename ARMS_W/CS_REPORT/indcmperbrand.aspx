<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="indcmperbrand.aspx.cs" Inherits="ARMS_W.CS_REPORT.indcmperbrand" %>
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td align="left" valign="middle">
                    <b>INDIVIDUAL CREDIT MEMO PER BRAND</b>
                </td>
   ...
   <div class="page_header_y">
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="~\CS_REPORT\rpt\individualcmperbrand.rpt">
            </Report>
