...
{
    public partial class individualytdcm : System.Web.UI.Page
    {
        ...
        private void LoadReport()
        {
            ...
            string foldername = MapPath("~/CS_REPORT/rpt/individualytdcmreport.rpt");
            ...
            DataTable user_counterid = SqlDbHelper.getDataDT("SELECT cardcode FROM SAPSERVER.MATIMCO.dbo.arms_vw_individualytdcmreport WHERE cardname='" + cardname + "' GROUP BY cardcode");
