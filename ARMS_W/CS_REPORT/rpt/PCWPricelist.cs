...
namespace ARMS_W.CS_REPORT.rpt {
    ...
    public class PCWPricelist : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "ARMS_W.CS_REPORT.rpt.PCWPricelist.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPCWPricelist : Component, ICachedReport {
        
        public CachedPCWPricelist() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PCWPricelist rpt = new PCWPricelist();
            rpt.Site = this.Site;
            return rpt;
        }
