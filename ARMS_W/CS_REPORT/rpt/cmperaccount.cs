...
namespace ARMS_W.CS_REPORT.rpt {
    ...
    public class cmperaccount : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "ARMS_W.CS_REPORT.rpt.cmperaccount.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedcmperaccount : Component, ICachedReport {
        
        public Cachedcmperaccount() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            cmperaccount rpt = new cmperaccount();
            rpt.Site = this.Site;
            return rpt;
        }
