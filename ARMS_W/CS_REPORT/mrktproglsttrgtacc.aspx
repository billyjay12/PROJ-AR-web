<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mrktproglsttrgtacc.aspx.cs" Inherits="ARMS_W.CS_REPORT.mrktproglsttrgtacc" %>
...
<body>
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td align="left" valign="middle">
                    <b>MARKETING PROGRAM LIST OF TARGET ACCOUNTS</b>
                </td>
   ...
   <div class="page_header_y">
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Text="Marketing Program No"></asp:Label>
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="U:\Crystal Reports\mrktproglistoftrgtaccounts.rpt">
            </Report>
