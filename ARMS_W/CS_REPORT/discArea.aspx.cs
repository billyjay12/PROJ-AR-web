...
{
    public partial class discArea : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string foldername = Server.MapPath("~/CS_REPORT/rpt/Disc-Per-Area.rpt");
            ...
            try
            {
                ...
                ReportHelper.GetAreas(Session["username"].ToString(), "Brand", ref PFIELDS, ref param_values);
                ...
                if (!has_brand) ReportDoc.ParameterFields["SO"].CurrentValues.Add(brand_default_val);
