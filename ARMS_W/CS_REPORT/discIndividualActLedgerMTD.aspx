<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="discIndividualActLedgerMTD.aspx.cs" Inherits="ARMS_W.CS_REPORT.discIndividualActLedgerMTD" %>
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td align="left" valign="middle">
                    <b>INDIVIDUAL DISCOUNT - LEDGER TYPE (MTD)</b>
                </td>
   ...
   <div class="page_header_y">
    ...
    <div class="simple_box">
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <report filename="~\CS_REPORT\rpt\Disc-RunningMTD-IndividualAccount.rpt">
            </report>
