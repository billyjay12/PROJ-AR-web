...
{
    public partial class indcmperbrand : System.Web.UI.Page
    {
        ...
        private void LoadReport()
        {
            ...
            string foldername = MapPath("~/CS_REPORT/rpt/individualcmperbrand.rpt");
            ...
            DataTable user_counterid = SqlDbHelper.getDataDT("SELECT cardcode FROM SAPSERVER.MATIMCO.dbo.arms_vw_individualcmperbrand WHERE cardname='" + cardname + "' GROUP BY cardcode");
