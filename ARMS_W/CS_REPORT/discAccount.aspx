<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="discAccount.aspx.cs" Inherits="ARMS_W.CS_REPORT.discAccount" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <report filename="~\CS_REPORT\rpt\Disc-PerAcct-ALL.rpt">
            </report>
