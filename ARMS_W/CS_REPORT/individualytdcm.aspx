<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="individualytdcm.aspx.cs" Inherits="ARMS_W.CS_REPORT.individualytdcm" %>
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td align="left" valign="middle">
                    <b>INDIVIDUAL CREDIT MEMO - LEDGER TYPE (YTD)</b>
                </td>
   ...
   <div class="page_header_y">
    ...
    <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" 
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="~\CS_REPORT\rpt\individualytdcmreport.rpt">
            </Report>
