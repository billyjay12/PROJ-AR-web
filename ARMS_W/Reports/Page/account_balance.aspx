<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="account_balance.aspx.cs" Inherits="ARMS_W.Reports.Page.account_balance" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Reports\RDLC\account_balance.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="SqlDataSource1" 
                        Name="rpt_account_balance" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <br />
