<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArmsApprovalMonitoring.aspx.cs" Inherits="ARMS_W.Reports.Page.ArmsApprovalMonitoring" %>
                    ...
                    <div class="rTableRow">
                        <div class="rTableCell">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                                ...
                                Height="686px">
                                <ServerReport ReportPath="/arms reports/ARMS Approval Monitoring" ReportServerUrl="http://reportserver/webreportserver" />
                            </rsweb:ReportViewer>
                        </div>
                    </div>
                </div>
