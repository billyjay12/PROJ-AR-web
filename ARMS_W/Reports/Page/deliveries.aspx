<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deliveries.aspx.cs" Inherits="ARMS_W.Reports.Page.deliveries" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Reports\RDLC\deliveries.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="SqlDataSource1" Name="rpt_deliveries" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
